This file contains code for the Conjugate SABRE method from \cite{Davies17_COST}.
The method is contained in C_SABRE.R and that will call the the other functions, 
