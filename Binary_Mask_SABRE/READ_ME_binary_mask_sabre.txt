This file contains code for the Binary Mask SABRE method from \cite{Davies17_COST}.
...
mean_sig_prop, prop_var_sig - MCMC tuning parameters need when all \gamma=0
...
wf - intercept parameter and regression coefficients (\textbf{w}^*)
